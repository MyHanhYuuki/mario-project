...
#define ID_SPRITE_MARIO_TANUKI_IDLE (ID_SPRITE_MARIO_BIG + 100)
#define ID_SPRITE_MARIO_TANUKI_IDLE_LEFT (ID_SPRITE_MARIO_BIG_IDLE + 10)
#define ID_SPRITE_MARIO_TANUKI_IDLE_RIGHT (ID_SPRITE_MARIO_BIG_IDLE + 20)
#define ID_SPRITE_MARIO_TANUKI_WALKING (ID_SPRITE_MARIO_BIG + 200)
#define ID_SPRITE_MARIO_TANUKI_WALKING_LEFT (ID_SPRITE_MARIO_BIG_WALKING + 10)
#define ID_SPRITE_MARIO_TANUKI_WALKING_RIGHT (ID_SPRITE_MARIO_BIG_WALKING + 20)
#define ID_SPRITE_MARIO_TANUKI_RUNNING (ID_SPRITE_MARIO_BIG + 300)
#define ID_SPRITE_MARIO_TANUKI_RUNNING_LEFT (ID_SPRITE_MARIO_BIG_RUNNING + 10)
#define ID_SPRITE_MARIO_TANUKI_RUNNING_RIGHT (ID_SPRITE_MARIO_BIG_RUNNING + 20)
#define ID_SPRITE_MARIO_TANUKI_JUMP (ID_SPRITE_MARIO_BIG + 400)
#define ID_SPRITE_MARIO_TANUKI_JUMP_WALK (ID_SPRITE_MARIO_BIG_JUMP + 10)
#define ID_SPRITE_MARIO_TANUKI_JUMP_WALK_LEFT (ID_SPRITE_MARIO_BIG_JUMP_WALK + 2)
#define ID_SPRITE_MARIO_TANUKI_JUMP_WALK_RIGHT (ID_SPRITE_MARIO_BIG_JUMP_WALK + 6)
#define ID_SPRITE_MARIO_TANUKI_JUMP_RUN (ID_SPRITE_MARIO_BIG_JUMP + 20)
#define ID_SPRITE_MARIO_TANUKI_JUMP_RUN_LEFT (ID_SPRITE_MARIO_BIG_JUMP_RUN + 2)
#define ID_SPRITE_MARIO_TANUKI_JUMP_RUN_RIGHT (ID_SPRITE_MARIO_BIG_JUMP_RUN + 6)
#define ID_SPRITE_MARIO_TANUKI_SIT (ID_SPRITE_MARIO_BIG + 500)
#define ID_SPRITE_MARIO_TANUKI_SIT_LEFT (ID_SPRITE_MARIO_BIG_SIT + 10)
#define ID_SPRITE_MARIO_TANUKI_SIT_RIGHT (ID_SPRITE_MARIO_BIG_SIT + 20)
#define ID_SPRITE_MARIO_TANUKI_BRACE (ID_SPRITE_MARIO_BIG + 600)
#define ID_SPRITE_MARIO_TANUKI_BRACE_LEFT (ID_SPRITE_MARIO_BIG_BRACE + 10)
#define ID_SPRITE_MARIO_TANUKI_BRACE_RIGHT (ID_SPRITE_MARIO_BIG_BRACE + 20)
...
#define ID_SPRITE_GOOMBA_PARA (ID_SPRITE_GOOMBA + 10)
#define ID_SPRITE_GOOMBA_PARA_WALK (ID_SPRITE_GOOMBA_PARA + 1000)
#define ID_SPRITE_GOOMBA_PARA_DIE (ID_SPRITE_GOOMBA_PARA + 2000)
...
#define ID_SPRITE_MUSROOM 70000
#define ID_SPRITE_LIFE_MUSROOM 70001
#define ID_SPRITE_LEAF 70002

#define ID_PIPE_VETICAL_FULL 80000
#define ID_PIPE_VETICAL_HALF_TOP 80001
#define ID_PIPE_VETICAL_HALF_BOTTOM 80002
#define ID_PIPE_HORIZONTAL_FULL 80010
#define ID_PIPE_HORIZONTAL_HALF_LEFT 80011
#define ID_PIPE_HORIZONTAL_HALF_RIGHT 80012

#define ID_VENUS_FIRE_TRAP_LEFT_TOP 90000
#define ID_VENUS_FIRE_TRAP_LEFT_BOTTOM 90001
#define ID_VENUS_FIRE_TRAP_RIGHT_TOP 90003
#define ID_VENUS_FIRE_TRAP_RIGHT_BOTTOM 90004
